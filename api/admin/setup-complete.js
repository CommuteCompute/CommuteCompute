...
const MELBOURNE_STOP_IDS = {
  'south yarra': { train: 'SYR', tram: '18606', stationName: 'South Yarra Station', line: 'Sandringham/Pakenham/Cranbourne' },
  'prahran': { train: 'PRA', tram: '18611', stationName: 'Prahran Station', line: 'Sandringham' },
  'windsor': { train: 'WIN', tram: '18614', stationName: 'Windsor Station', line: 'Sandringham' },
  'balaclava': { train: 'BCV', tram: '18632', stationName: 'Balaclava Station', line: 'Sandringham' },
  'elsternwick': { train: 'ELS', tram: null, stationName: 'Elsternwick Station', line: 'Sandringham' },
  'sandringham': { train: 'SHM', tram: null, stationName: 'Sandringham Station', line: 'Sandringham' },
  'richmond': { train: 'RMD', tram: '19278', stationName: 'Richmond Station', line: 'All lines' },
  'hawthorn': { train: 'HAW', tram: '20566', stationName: 'Hawthorn Station', line: 'Glen Waverley/Alamein' },
  'camberwell': { train: 'CAM', tram: '18964', stationName: 'Camberwell Station', line: 'Glen Waverley/Alamein' },
  'caulfield': { train: 'CFD', tram: '18457', stationName: 'Caulfield Station', line: 'Pakenham/Cranbourne/Frankston' },
  'carnegie': { train: 'CNE', tram: null, stationName: 'Carnegie Station', line: 'Pakenham/Cranbourne' },
  'oakleigh': { train: 'OAK', tram: null, stationName: 'Oakleigh Station', line: 'Pakenham/Cranbourne' },
  'clifton hill': { train: 'CHL', tram: '6046', stationName: 'Clifton Hill Station', line: 'Hurstbridge/Mernda' },
  'northcote': { train: 'NCE', tram: '6040', stationName: 'Northcote Station', line: 'Hurstbridge/Mernda' },
  'footscray': { train: 'FSY', tram: null, stationName: 'Footscray Station', line: 'Werribee/Williamstown/Sunbury' },
  'brunswick': { train: 'BWK', tram: '16719', stationName: 'Brunswick Station', line: 'Upfield' },
  'coburg': { train: 'COB', tram: null, stationName: 'Coburg Station', line: 'Upfield' },
  'broadmeadows': { train: 'BMS', tram: null, stationName: 'Broadmeadows Station', line: 'Craigieburn' },
  'melbourne': { train: 'FSS', tram: '18090', stationName: 'Flinders Street Station', line: 'All lines' },
  'cbd': { train: 'FSS', tram: '18090', stationName: 'Flinders Street Station', line: 'All lines' },
};
