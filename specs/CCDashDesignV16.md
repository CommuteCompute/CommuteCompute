...
# CCDashDesignV16 - Commute Compute™ Dashboard Specification

**Status:** UNLOCKED — V16.0 (active development)
**Version:** 16.0
**Modified Date:** 2026-03-02
**Effective Date:** 2026-03-02
**Display:** 800×480px e-ink (TRMNL device)
**Refresh:** 60-second partial refresh cycle
**Renderer:** ccdash-renderer.js v3.0
**CommuteCompute:** v4.0 (Unified Engine, Metro Tunnel Compliant)

---

> **UNLOCKED** — V16.0 specification under active development (2026-03-02).
> Unified Engine: api/screen.js merged into api/commutecompute.js. GTFS coordinate-based stop detection,
> 5 Intelligence Engines, Metro Tunnel compliance, strictly-live GTFS-RT data, and full transit pipeline.
>
> **V16.0 Changes from V15 (current):**
> - **Unified Engine:** api/screen.js merged into api/commutecompute.js — single endpoint for admin JSON, e-ink PNG/BMP, and debug diagnostics
> - **GTFS coordinate-based stop detection:** findNearestStops() searches 226 metro stations, 1637 tram stops, 4151 bus stops by proximity
> - **Engine alighting intelligence:** coordinate-based destination resolution, no hardcoded Flinders Street Station fallback
> - **Shared haversine utility:** single source of truth replacing 3 duplicate implementations
> - **Shared utility extraction:** time-format.js, fetch-retry.js, suburb-extract.js, config-token.js
> - **Renderer v3.0:** transit countdown fix (trusts leg.minutes, 180-min sanity cap), cafe closed case-insensitive matching
> - **AltTransit gate fix:** only activates when ALL transit is cancelled/suspended
> - **Backward-compatible rewrite:** /api/screen -> /api/commutecompute via vercel.json (firmware devices continue to work)
>
> **V15.0 Changes from V14:
...
|---------|------|---------|
| v3.0 | 2026-03-02 | **V16.0** — Unified Engine (screen.js merged into commutecompute.js), GTFS coordinate-based stop detection, shared utilities, renderer countdown fix |
...
## 13. V16.0 Implementation Checklist

**V16.0 Core (Renderer v3.0, Engine v4.0):**
