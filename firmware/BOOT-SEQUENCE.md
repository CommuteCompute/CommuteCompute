...
> **Note:** This document describes the legacy WiFiManager boot sequence used in firmware versions prior to v7.0. Current firmware (CC-FW-7.7.0) uses BLE provisioning. See [QUICK_START.md](QUICK_START.md) for current setup instructions.
...
| `setup_transit_api` | Transport Victoria API key OR devId configured | Setup |
...
2. **NO WATCHDOG**: Removed in v7.2.1
   - Caused crashes in earlier versions
...
- **v7.2.1**: Current version (CC-FW-7.4.3)
  - Unified setup screen
