...
Key requirements:
- CCDashDesignV16.0 spec is **LOCKED** — no UI changes without approval
...
3. Check if it conflicts with the CCDashDesignV16.0 spec (locked)
...
7.5. Sign off your commits (`git commit -s`) — see DCO section below
...
By adding `Signed-off-by`, you certify the [Developer Certificate of Origin v1.1](https://developercertificate.org/):
